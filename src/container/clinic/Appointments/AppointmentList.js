...
import { DeleteAppointment, DeleteAppointmentAction, GetAppointmentListAction } from '../../../redux/Clinic/clinicActions';
...
const TABLE_HEAD = ["Patient-Name","Appointment-Date", "Slot", "Status", "Doctor-Name", ""];
                      ...
                      {/* <td className={classes}>
                        <div className="flex flex-col">
                          ...
                          <Typography
                            ...
                            className="font-normal opacity-70"
                          >
                            {appointment.patient_id_id.patient_First_Name}
                          </Typography>
                        </div>
                      </td> */}
                      <td className={`${classes} flex space-x-4 flex-row `} >
                        <AddAppointments userDetails={appointment} />
